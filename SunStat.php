...
class plgSystemSunStat extends JPlugin
{
	...
	function onAfterRender()
	{
		...
		$ym		= '<!-- Yandex.Metrika counter --><script type="text/javascript">var yaParams = {'.$ym_yaParams.'};</script><script type="text/javascript">(function (d, w, c) {(w[c] = w[c] || []).push(function() { try { w.yaCounter' . $ym_id . ' = new Ya.Metrika({id:' . $ym_id . ', webvisor:' . $ym_webvisor . ', clickmap:' . $ym_clickMap . ', trackLinks:' . $ym_linksOut . ', accurateTrackBounce:' . $ym_accurateTrackBounce . ', trackHash:' . $ym_trackHash . ','. $ym_noIndex . ',params:window.yaParams||{ }});} catch(e){}}); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = (d.location.protocol == "https:" ? "https:" : "http:") + "//mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); }})(document, window, "yandex_metrika_callbacks");</script><noscript><div><img src="//mc.yandex.ru/watch/' . $ym_id . '?ut=noindex" style="position:absolute; left:-9999px;" alt="" /></div></noscript><!-- /Yandex.Metrika counter -->';
