...
class plgSystemSunStat extends JPlugin
{
	...
	function onAfterRender()
	{
		...
		//Extended functions
		//Yandex Metrika
		if ($ym_yaParams !='')	{$ym_ef_yaParams	='var yaParams = {'.$ym_yaParams.'}; </script><script type="text/javascript">';  $ym_ef_yaParams2='params:window.yaParams||{ }';} else $ga_ef_yaParams='';
		...
		if ($ym_noIndex)		$ym_ef_noindex	='ut:"noindex",';					 									else $ym_ef_noindex='';
		//Google Analytics
		...
		$ym		= '<!-- Yandex.Metrika counter --><script type="text/javascript"></script><script type="text/javascript">' . $ym_ef_yaParams . '(function (d, w, c) {(w[c] = w[c] || []).push(function() { try { w.yaCounter' . $ym_id . ' = new Ya.Metrika({id:'.$ym_id.';, '.$ym_ef_webvisor.$ym_ef_clickmap.$ym_ef_linksout.$ym_ef_atb.$ym_ef_trackhash.$ym_ef_noindex.$ym_ef_yaParams2.'});} catch(e){}}); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = (d.location.protocol == "https:" ? "https:" : "http:") + "//mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); }})(document, window, "yandex_metrika_callbacks");</script><noscript><div><img src="//mc.yandex.ru/watch/' . $ym_id . '?ut=noindex" style="position:absolute; left:-9999px;" alt="" /></div></noscript><!-- /Yandex.Metrika counter -->';
